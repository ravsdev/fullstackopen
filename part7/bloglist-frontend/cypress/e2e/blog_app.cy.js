describe('Blog app', function () {
    ...
    describe('Login', () => {
        ...
        it('fails with wrong credentials', () => {
            ...
            cy.get('.notification span').should(
                'have.css',
                'color',
                'rgb(255, 0, 0)'
            )
    ...
    describe('When logged in...', () => {
        ...
        describe('and several blogs exists', () => {
            ...
            it('Users can like a blog', () => {
                ...
                cy.get('@Blog')
                    .find('.togglableContent div')
                    .children('[data-like]')
                    .should('have.text', 'Likes: 1')
            })
            ...
            it('the blogs are ordered according to likes with the blog with the most likes being first', () => {
                ...
                cy.get('.blog')
                    .eq(0)
                    .should('contain', 'Third Blog Title Third Blog Author')
                cy.get('.blog')
                    .eq(1)
                    .should('contain', 'Second Blog Title Second Blog Author')
                cy.get('.blog')
                    .eq(2)
                    .should('contain', 'First Blog Title First Blog Author')
            })
        })
    })
})
